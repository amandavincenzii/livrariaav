...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/aluno/Documentos/Livraria_AmandaV/livrariaav/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('livrariaav-py3.8' == '') {
...
alias deactivate = source '/home/aluno/Documentos/Livraria_AmandaV/livrariaav/.venv/bin/deactivate.nu'
